...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="middle">
                <div class="directory">
                    <div class="message">Fresh Calamari</div>
                ...
                <div class="product_and_description">
                    <div class="box picture-container">
                        <div class="picture"
                            style="background-image: url(../../images/seafoodAisle/fresh-calamari.jpg)">
                        </div>
                    </div>
                    ...
                    <div class="box description">
                        <div class="align">
                            ...
                            <div class="descriptionRow" data-value="120" data-measure="g"><span>WEIGHT</span> 120g</div>

                            <div class="descriptionRow" data-value="35.00"><span>PRICE</span> $35.00</div>
                        ...
                        <div class="smallCarousel">
                            ...
                            <!-- more description -->
                            <div class="detail">These fresh Calamari are from a unique species of Squid that only lives
                                near the coast of New Zealand! They can be prepared in a myriad of ways!</div>
                        </div>
                    </div>
                </div>
