...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="middle">
                <div class="directory">
                    <div class="message">Red Seabream</div>
                    <div class="innerAisle">SEAFOOD</div>
                </div>

                <div class="product_and_description">
                    <div class="box picture-container">
                        <div class="picture" style="background-image: url(../../images/seafoodAisle/red-seabream.jpg)">
                        </div>
                    </div>
                    ...
                    <div class="box description">
                        <div class="align">
                            ...
                            <div class="descriptionRow" data-value="30.99"><span>PRICE</span> $30.99</div>
                        ...
                        <div class="smallCarousel">
                            ...
                            <!-- more description -->
                            <div class="detail">These Red Seabreams, originating from Japan, can be expected to serve at
                                most two persons. Because of theor small size, they can be prepared quite quickly</div>
                        </div>
                    </div>
                </div>
