...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="middle">
                <div class="directory">
                    <div class="message">Salmon</div>
                    <div class="innerAisle">SEAFOOD</div>
                </div>

                <div class="product_and_description">
                    <div class="box picture-container">
                        <div class="picture" style="background-image: url(../../images/seafoodAisle/Salmon.jpg)">
                        </div>
                    </div>
                    ...
                    <div class="box description">
                        <div class="align">
                            ...
                            <div class="descriptionRow" data-value="40" data-measure="g"><span>WEIGHT</span> 40g</div>

                            <div class="descriptionRow" data-value="60.00"><span>PRICE</span> $60.00</div>
                        ...
                        <div class="smallCarousel">
                            ...
                            <!-- more description -->
                            <div class="detail">These Salmon from Vancouver are seen as one of the best-selling fish!
                                Their expensive price is due to how tasty and rare they are!</div>
                        </div>
                    </div>
                </div>
