...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="middle">
                <div class="directory">
                    <div class="message">Blue Crab</div>
                    <div class="innerAisle">SEAFOOD</div>
                </div>

                <div class="product_and_description">
                    <div class="box picture-container">
                        <div class="picture" style="background-image: url(../../images/seafoodAisle/blue-crab.jpg)">
                        </div>
                    </div>
                    ...
                    <div class="box description">
                        <div class="align">
                            ...
                            <div class="descriptionRow" data-value="100" data-measure="g"><span>WEIGHT</span> 100g</div>

                            <div class="descriptionRow" data-value="50.00"><span>PRICE</span> $50.00</div>
                        ...
                        <div class="smallCarousel">
                            ...
                            <!-- more description -->
                            <div class="detail">Blue Crabs are another wonderful wild life creature! These crabs from
                                South America go well with curry and other spicy foods!</div>
                        </div>
                    </div>
                </div>
