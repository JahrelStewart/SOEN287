...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="middle">
                <div class="directory">
                    <div class="message">Mussels</div>
                    <div class="innerAisle">SEAFOOD</div>
                </div>

                <div class="product_and_description">
                    <div class="box picture-container">
                        <div class="picture" style="background-image: url(../../images/seafoodAisle/mussels.jpg)">
                        </div>
                    </div>
                    ...
                    <div class="box description">
                        <div class="align">
                            ...
                            <div class="descriptionRow" data-value="15.00"><span>PRICE</span> $15.00</div>
                        ...
                        <div class="smallCarousel">
                            ...
                            <!-- more description -->
                            <div class="detail">These Mussels from Croatia can be amazing snacks! Their small size
                                allows them to be prepared quickly with little effort!</div>
                        </div>
                    </div>
                </div>
