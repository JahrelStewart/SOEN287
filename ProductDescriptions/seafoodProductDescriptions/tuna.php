...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="middle">
                <div class="directory">
                    <div class="message">Tuna</div>
                    <div class="innerAisle">SEAFOOD</div>
                </div>

                <div class="product_and_description">
                    <div class="box picture-container">
                        <div class="picture" style="background-image: url(../../images/seafoodAisle/tuna.jpg)">
                        </div>
                    </div>
                    ...
                    <div class="box description">
                        <div class="align">
                            ...
                            <div class="descriptionRow" data-value="400" data-measure="g"><span>WEIGHT</span> 400g</div>

                            <div class="descriptionRow" data-value="150.00"><span>PRICE</span> $150.00</div>
                        ...
                        <div class="smallCarousel">
                            ...
                            <!-- more description -->
                            <div class="detail">These tuna from Indonesia are very versatile in terms of the variety of
                                foods that can be prepared using them! They are seen around the world as a delicacy!
                            </div>
                        </div>
                    </div>
                </div>
