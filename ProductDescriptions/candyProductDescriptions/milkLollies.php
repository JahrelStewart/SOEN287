...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="middle">
                <div class="directory">
                    <div class="message">Milk Lollies</div>
                    <div class="innerAisle">CANDY</div>
                </div>

                <div class="product_and_description">
                    <div class="box picture-container">
                        <div class="picture" style="background-image: url(../../images/candyAisle/milk-lollies.jpg)">
                        </div>
                    </div>
                    ...
                    <div class="box description">
                        <div class="align">
                            ...
                            <div class="descriptionRow" data-value="10" data-measure="g"><span>WEIGHT</span> 10g</div>

                            <div class="descriptionRow" data-value="0.56"><span>PRICE</span> $0.56</div>
                        ...
                        <div class="smallCarousel">
                            ...
                            <!-- more description -->
                            <div class="detail">These Milk Lollies come from The Netherlands. Munch of these whenever
                                you are craving for something sweet and creamy!</div>
                        </div>
                    </div>
                </div>
