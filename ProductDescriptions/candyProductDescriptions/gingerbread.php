...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="middle">
                <div class="directory">
                    <div class="message">GingerBread</div>
                    <div class="innerAisle">CANDY</div>
                </div>

                <div class="product_and_description">
                    <div class="box picture-container">
                        <div class="picture" style="background-image: url(../../images/candyAisle/gingerbread.jpg)">
                        </div>
                    </div>
                    ...
                    <div class="box description">
                        <div class="align">
                            ...
                            <div class="descriptionRow" data-value="75" data-measure="g"><span>WEIGHT</span> 75g</div>

                            <div class="descriptionRow" data-value="10.03"><span>PRICE</span> $10.03</div>
                        ...
                        <div class="smallCarousel">
                            ...
                            <!-- more description -->
                            <div class="detail">GingerBreads are wonderful Christmas treats! Speaking about Christmas,
                                these gingerbreads come from the cold and snowy north of Antartica. Maybe Santa made
                                them!! </div>
                        </div>
                    </div>
                </div>
