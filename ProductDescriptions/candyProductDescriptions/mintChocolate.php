...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="middle">
                <div class="directory">
                    <div class="message">Mint Chocolate</div>
                    <div class="innerAisle">CANDY</div>
                </div>

                <div class="product_and_description">
                    <div class="box picture-container">
                        <div class="picture" style="background-image: url(../../images/candyAisle/mint-chocolate.jpg)">
                        </div>
                    </div>
                    ...
                    <div class="box description">
                        <div class="align">
                            ...
                            <div class="descriptionRow" data-value="50" data-measure="g"><span>WEIGHT</span> 50g</div>

                            <div class="descriptionRow" data-value="4.55"><span>PRICE</span> $4.55</div>
                        ...
                        <div class="smallCarousel">
                            ...
                            <!-- more description -->
                            <div class="detail">Mint Chocolates are amazing sweet treats! Enjoy the taste of velvety
                                chocolate as a breath of cool mint comes rushing in right after!</div>
                        </div>
                    </div>
                </div>
