...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="middle">
                <div class="directory">
                    <div class="message">Ginger Muffins</div>
                    <div class="innerAisle">CANDY</div>
                </div>

                <div class="product_and_description">
                    <div class="box picture-container">
                        <div class="picture" style="background-image: url(../../images/candyAisle/muffin.jpg)">
                        </div>
                    </div>
                    ...
                    <div class="box description">
                        <div class="align">
                            ...
                            <div class="descriptionRow" data-value="20" data-measure="g"><span>WEIGHT</span> 20g</div>

                            <div class="descriptionRow" data-value="4.41"><span>PRICE</span> $4.41</div>
                        ...
                        <div class="smallCarousel">
                            ...
                            <!-- more description -->
                            <div class="detail">Cupcakes are a family favourite! Think of them as small cakes that are
                                just enough to satisfy your hunger. You won't regret a single bite from the cupcakes
                                that hail from Mexico.</div>
                        </div>
                    </div>
                </div>
