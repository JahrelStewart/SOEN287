...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="middle">
                <div class="directory">
                    <div class="message">Fudge Donuts</div>
                    <div class="innerAisle">CANDY</div>
                </div>

                <div class="product_and_description">
                    <div class="box picture-container">
                        <div class="picture" style="background-image: url(../../images/candyAisle/donut.jpg)">
                        </div>
                    </div>
                    ...
                    <div class="box description">
                        <div class="align">
                            ...
                            <div class="descriptionRow" data-value="125" data-measure="g"><span>WEIGHT</span> 125g</div>

                            <div class="descriptionRow" data-value="5.69"><span>PRICE</span> $5.69</div>
                        ...
                        <div class="smallCarousel">
                            ...
                            <!-- more description -->
                            <div class="detail">Donuts are great deserts! You can count on these Norwegian donuts to
                                fill your stomachs with fudgey goodness!</div>
                        </div>
                    </div>
                </div>
