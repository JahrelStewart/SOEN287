...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="middle">
                <div class="directory">
                    <div class="message">Assorted Gummies</div>
                    <div class="innerAisle">CANDY</div>
                </div>

                <div class="product_and_description">
                    <div class="box picture-container">
                        <div class="picture" style="background-image: url(../../images/candyAisle/gummies.jpg)">
                        </div>
                    </div>
                    ...
                    <div class="box description">
                        <div class="align">
                            ...
                            <div class="descriptionRow" data-value="150" data-measure="g"><span>WEIGHT</span> 150g</div>

                            <div class="descriptionRow" data-value="1.75"><span>PRICE</span> $1.75</div>
                        ...
                        <div class="smallCarousel">
                            ...
                            <!-- more description -->
                            <div class="detail">Gummies are a wonderful treat. They come in all shapes and sizes.
                                If you're looking for a quick sugar rush, chew on these for a bit and watch as your
                                taste buds melt!</div>
                        </div>
                    </div>
                </div>
