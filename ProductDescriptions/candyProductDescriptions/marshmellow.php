...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="middle">
                <div class="directory">
                    <div class="message">Marshmellow</div>
                    <div class="innerAisle">CANDY</div>
                </div>

                <div class="product_and_description">
                    <div class="box picture-container">
                        <div class="picture" style="background-image: url(../../images/candyAisle/marshmellow.jpg)">
                        </div>
                    </div>
                    ...
                    <div class="box description">
                        <div class="align">
                            ...
                            <div class="descriptionRow" data-value="25" data-measure="g"><span>WEIGHT</span> 25g</div>

                            <div class="descriptionRow" data-value="8.40"><span>PRICE</span> $8.40</div>
                        ...
                        <div class="smallCarousel">
                            ...
                            <!-- more description -->
                            <div class="detail">These Montreal Marshmellows are soft bite-size treats that go really
                                well with crackers. gather around a campfire and much on these with your friends and
                                family!</div>
                        </div>
                    </div>
                </div>
