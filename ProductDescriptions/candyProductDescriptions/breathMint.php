...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="middle">
                <div class="directory">
                    <div class="message">Breath Mint</div>
                    <div class="innerAisle">CANDY</div>
                </div>

                <div class="product_and_description">
                    <div class="box picture-container">
                        <div class="picture" style="background-image: url(../../images/candyAisle/breath-mint.jpg)">
                        </div>
                    </div>
                    ...
                    <div class="box description">
                        <div class="align">
                            ...
                            <div class="descriptionRow" data-value="2" data-measure="g"><span>WEIGHT</span> 2g</div>

                            <div class="descriptionRow" data-value="0.10"><span>PRICE</span> $0.10</div>
                        ...
                        <div class="smallCarousel">
                            ...
                            <!-- more description -->
                            <div class="detail">You can count on these to give your breath a clean and refreshing smell!
                                Before
                                going anywhere, give them a quick chew.</div>
                        </div>
                    </div>
                </div>
