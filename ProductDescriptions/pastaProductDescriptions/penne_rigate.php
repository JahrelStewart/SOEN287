...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="middle">
                <div class="directory">
                    <div class="message">Penne Rigate</div>
                    <div class="innerAisle">PASTA</div>
                </div>

                <div class="product_and_description">
                    <div class="box picture-container">
                        <div class="picture" style="background-image: url(../../images/pastaAisle/penne-rigate.png)">
                        </div>
                    </div>
                    ...
                    <div class="box description">
                        <div class="align">
                            ...
                            <div class="descriptionRow" data-value="454" data-measure="g"><span>WEIGHT</span> 454g</div>
                        ...
                        <div class="smallCarousel">
                            ...
                            <!-- more description -->
                            <div class="detail">Our organic penne rigate is made in Italy at an authentic pastificio
                                dedicated to making only the highest quality pastas. Made with organic durum wheat,
                                our pasta is the perfect base to any dish. Hollow and ridged, this pasta holds up in
                                rustic sauces and is exceptional in baked dishes.</div>
