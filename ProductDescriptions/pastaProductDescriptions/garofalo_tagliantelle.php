...
<head>
    ...
    <title>Garofalo Tagliantelle</title>
</head>
...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="middle">
                <div class="directory">
                    <div class="message">Garofalo Tagliatelle</div>
                    <div class="innerAisle">PASTA</div>
                </div>

                <div class="product_and_description">
                    <div class="box picture-container">
                        <div class="picture"
                            style="background-image: url(../../images/pastaAisle/garofalo-tagliantelle.jpg)">
                        </div>
                    </div>
                    ...
                    <div class="box description">
                        <div class="align">
                            ...
                            <div class="descriptionRow" data-value="500" data-measure="g"><span>WEIGHT</span> 500g</div>

                            <div class="descriptionRow" data-value="3.99"><span>PRICE</span> $3.99</div>
                        ...
                        <div class="smallCarousel">
                            ...
                            <!-- more description -->
                            <div class="detail">Tagliatelle is long, flat pasta ribbons. Tagliatelle is a traditional
                                type of pasta from Emilia-Romagna and Marches regions of Italy.
                                Tagliatelle is traditionally served with a meat or Bolognese sauce, but also works
                                extremely well with a cheese or cream sauce.</div>

                            <!-- 
                                which is typical type of traditional ,but the best condiments are sauces made from meat: slow-cooked sauces with meat and
                                mushrooms,
                                made from beef and pork, sausage or giblets. The recipe with pajata (calf intestines) is
                                a classic dish. -->
                        </div>
                    </div>
                </div>
