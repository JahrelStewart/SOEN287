...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="middle">
                <div class="directory">
                    <div class="message">Dececco Rigatoni</div>
                ...
                <div class="product_and_description">
                    <div class="box picture-container">
                        <div class="picture"
                            style="background-image: url(../../images/pastaAisle/rigatoni-dececco.png)">
                        </div>
                    </div>
                    ...
                    <div class="box description">
                        <div class="align">
                            ...
                            <div class="descriptionRow" data-value="453" data-measure="g"><span>WEIGHT</span> 453g</div>

                            <div class="descriptionRow" data-value="9.99"><span>PRICE</span> $9.99</div>
                        ...
                        <div class="smallCarousel">
                            ...
                            <!-- more description -->
                            <div class="detail">Rigatoni, a pasta from Rome, has the characteristic ridged
                                external surface and a large diameter and thickness.
                                The shape is particularly versatile and is perfect with a variety of tomato or vegetable
                                sauces.</div>
