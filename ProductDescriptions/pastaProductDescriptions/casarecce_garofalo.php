...
<head>
    ...
    <title>Garofalo Casarecce</title>
</head>
...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="middle">
                <div class="directory">
                    <div class="message">Garofalo Casarecce</div>
                ...
                <div class="product_and_description">
                    <div class="box picture-container">
                        <div class="picture"
                            style="background-image: url(../../images/pastaAisle/casarecce-garofalo.jpg)">
                        </div>
                    </div>
                    ...
                    <div class="box description">
                        ...
                        <div class="smallCarousel">
                            ...
                            <!-- more description -->
                            <div class="detail">Casarecce is a versatile shape of short pasta that sticks to both light
                                sauces
                                and thicker ones, enhancing any condiment. They are a first-rate choice, prepared by
                                Italian
                                semolina, to bring the excellence and authentic taste of homemade pasta to the table.
                            </div>
