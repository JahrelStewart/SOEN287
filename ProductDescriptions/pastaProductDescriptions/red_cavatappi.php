...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="middle">
                <div class="directory">
                    <div class="message">Red Cavatappi</div>
                    <div class="innerAisle">PASTA</div>
                </div>

                <div class="product_and_description">
                    <div class="box picture-container">
                        <div class="picture" style="background-image: url(../../images/pastaAisle/Red-Cavatappi.png)">
                        </div>
                    </div>
                    ...
                    <div class="box description">
                        ...
                        <div class="smallCarousel">
                            ...
                            <!-- more description -->
                            <div class="detail">Cavatappi is the Italian word for corkscrew. It is a type of macaroni
                                that is formed like short springs. It is usually scored with lines or ridges on the
                                surface making it a perfect match for chunky sauces or pasta salads.</div>
