...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="middle">
                <div class="directory">
                    <div class="message">Pappardelle</div>
                    <div class="innerAisle">PASTA</div>
                </div>

                <div class="product_and_description">
                    <div class="box picture-container">
                        <div class="picture" style="background-image: url(../../images/pastaAisle/pappardelle.jpg)">
                        </div>
                    </div>
                    ...
                    <div class="box description">
                        <div class="align">
                            ...
                            <div class="descriptionRow" data-value="2.99"><span>PRICE</span> $2.99</div>
                        ...
                        <div class="smallCarousel">
                            ...
                            <!-- more description -->
                            <div class="detail">Pappardelle is a term from the tuscan dialect "pap pare" now
                                widespread in all regions designating a wide pasta strips served dry usually and
                                preferably with game sauce. Pappardelle are large, very broad, flat pasta, similar
                                to wide fettuccine, originating from the region of Tuscany. </div>
