...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="middle">
                <div class="directory">
                    <div class="message">Voiello Fusilli</div>
                    <div class="innerAisle">PASTA</div>
                </div>

                <div class="product_and_description">
                    <div class="box picture-container">
                        <div class="picture" style="background-image: url(../../images/pastaAisle/fusilli-voiello.jpg)">
                        </div>
                    </div>
                    ...
                    <div class="box description">
                        ...
                        <div class="smallCarousel">
                            ...
                            <!-- more description -->
                            <div class="detail">A sinuous spiral that enchants the sauce, inviting him to sneak
                                between the curves and to wrap the dough in roundness. The Fusilli ignite the
                                imagination, for delicious everyday recipes or unusual dishes, fascinating and
                                surprising.</div>
