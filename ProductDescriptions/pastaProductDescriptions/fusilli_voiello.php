...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            $product = $aisles->pasta->fusilli_voiello;
                    ...
                    <div class="product_and_description">
                        ...
                        <div class="box description">
                            ...
                            <div class="smallCarousel">
                                ...
                                <!-- more description -->
                                <div class="detail">The Fusilli ignites the imagination, for delicious everyday recipes or unusual dishes, fascinating and
                                surprising.</div>
                            </div>
                        </div>
                    </div>
