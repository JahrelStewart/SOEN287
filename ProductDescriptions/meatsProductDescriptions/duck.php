...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="middle">
                <div class="directory">
                    <div class="message">Grade A Duck</div>
                    <div class="innerAisle">MEATS</div>
                </div>

                <div class="product_and_description">
                    <div class="box picture-container">
                        <div class="picture" style="background-image: url(../../images/meatAisle/Grade_A_Duck.jpg)">
                        </div>
                    </div>
                    ...
                    <div class="box description">
                        <div class="align">
                            ...
                            <div class="descriptionRow" data-value="2461" data-measure="g"><span>WEIGHT</span> 2,461g
                                avg.
                            </div>

                            <div class="descriptionRow" data-value="19.23"><span>PRICE</span> $19.23</div>
                        ...
                        <div class="smallCarousel">
                            ...
                            <!-- more description -->
                            <div class="detail">
                                High in fat, protein and iron. Perfect for grilling as a substitue of steak. The liver
                                in particular is often used as a substitute for goose liver in foie gras!
                            </div>
                        </div>
                    </div>
                </div>
