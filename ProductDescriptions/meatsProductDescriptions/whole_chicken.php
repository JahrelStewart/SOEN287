...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="middle">
                <div class="directory">
                    <div class="message">Whole Chicken</div>
                    <div class="innerAisle">MEATS</div>
                </div>

                <div class="product_and_description">
                    <div class="box picture-container">
                        <div class="picture" style="background-image: url(../../images/meatAisle/whole_chicken.jpg)">
                        </div>
                    </div>
                    ...
                    <div class="box description">
                        <div class="align">
                            ...
                            <div class="descriptionRow" data-value="1600" data-measure="g"><span>WEIGHT</span> 1,600g
                            </div>

                            <div class="descriptionRow" data-value="14.59"><span>PRICE</span> $14.59</div>
                        ...
                        <div class="smallCarousel">
                            ...
                            <!-- more description -->
                            <div class="detail"> Raised Without Antibiotics, Canadian Farm Raised, Vegetable grain
                                fed with no animal by-products, may contain kidneys</div>
                        </div>
                    </div>
                </div>
