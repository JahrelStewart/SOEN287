...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            $product = $aisles->meats->pork_loin;
                    ...
                    <div class="product_and_description">
                        ...
                        <div class="box description">
                            ...
                            <div class="smallCarousel">
                                ...
                                <!-- more description -->
                                <div class="detail">Each hand-cut chop comes from Canadian-raised pork and cooks up tender, succulent and flavourful!
                                Pork from Quebec. 100% Satisfaction Guaranteed!</div>
                            </div>
                        </div>
                    </div>
