...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="middle">
                <div class="directory">
                    <div class="message">Pork Loin Center Chops</div>
                    <div class="innerAisle">MEATS</div>
                </div>

                <div class="product_and_description">
                    <div class="box picture-container">
                        <div class="picture" style="background-image: url(../../images/meatAisle/pork_loin.jpg)">
                        </div>
                    </div>
                    ...
                    <div class="box description">
                        <div class="align">
                            ...
                            <div class="descriptionRow" data-value="600" data-measure="g"><span>WEIGHT</span> 600g</div>

                            <div class="descriptionRow" data-value="8.49"><span>PRICE</span> $8.49</div>
                        ...
                        <div class="smallCarousel">
                            ...
                            <!-- more description -->
                            <div class="detail"> Fry these Boneless Centre and Ribs Chops or toss them on the grill.
                                Either way, your family will be enjoying pork for supper tonight! Each hand-cut chop
                                comes from Canadian-raised pork and cooks up tender, succulent and flavourful!
                                Pork from Quebec
                                - Made in Canada
