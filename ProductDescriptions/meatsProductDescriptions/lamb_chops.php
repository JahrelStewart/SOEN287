...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="middle">
                <div class="directory">
                    <div class="message">Lamb Rib Chops</div>
                    <div class="innerAisle">MEATS</div>
                </div>

                <div class="product_and_description">
                    <div class="box picture-container">
                        <div class="picture" style="background-image: url(../../images/meatAisle/lamb_chops.jpg)">
                        </div>
                    </div>
                    ...
                    <div class="box description">
                        <div class="align">
                            ...
                            <div class="descriptionRow" data-value="189" data-measure="g"><span>WEIGHT</span> 189g</div>

                            <div class="descriptionRow" data-value="12.12"><span>PRICE</span> $12.12</div>
                        ...
                        <div class="smallCarousel">
                            ...
                            <!-- more description -->
                            <div class="detail"> Whether you decide to grill them or fry them in a cast iron skillet
                                (or regular pan), these lamb chops have been a family favourite meal of ours for so
                                many years now.</div>
                        </div>
                    </div>
                </div>
