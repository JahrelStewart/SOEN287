...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="middle">
                <div class="directory">
                    <div class="message">Chicken Breasts</div>
                    <div class="innerAisle">MEATS</div>
                </div>

                <div class="product_and_description">
                    <div class="box picture-container">
                        <div class="picture" style="background-image: url(../../images/meatAisle/chicken_breasts.jpg)">
                        </div>
                    </div>
                    ...
                    <div class="box description">
                        <div class="align">
                            ...
                            <div class="descriptionRow" data-value="1000" data-measure="g"><span>WEIGHT</span> 1,000g
                            </div>

                            <div class="descriptionRow" data-value="13.69"><span>PRICE</span> $13.69</div>
                        ...
                        <div class="smallCarousel">
                            ...
                            <!-- more description -->
                            <div class="detail">Feel good about the chicken you serve your family with boneless
                                skinless chicken breast. These versatile ones are a delicious
                                addition to a wide variety of home-cooked meals including salads and BBQ.
                            </div>
                        </div>
                    </div>
                </div>
