...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            $product = $aisles->meats->sirloin_steak;
                    ...
                    <div class="product_and_description">
                        ...
                        <div class="box description">
                            ...
                            <div class="smallCarousel">
                                ...
                                <!-- more description -->
                                <div class="detail">It is a favourite of many in its own right due to its stronger meat flavour and
                                its tenderness throughout. When done right, its characteristic white strip of fat gives it an extra succulent
                                flavour.</div>
                            </div>
                        </div>
                    </div>
