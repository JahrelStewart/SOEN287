...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="middle">
                <div class="directory">
                    <div class="message">Smoked Sausages</div>
                    <div class="innerAisle">MEATS</div>
                </div>

                <div class="product_and_description">
                    <div class="box picture-container">
                        <div class="picture" style="background-image: url(../../images/meatAisle/sausages.jpg)">
                        </div>
                    </div>
                    ...
                    <div class="box description">
                        <div class="align">
                            ...
                            <div class="descriptionRow" data-value="7.56"><span>PRICE</span> $7.56</div>
                        ...
                        <div class="smallCarousel">
                            ...
                            <!-- more description -->
                            <div class="detail"> Cutting corners isn't one of our traditions, which is why we only use
                                premium cuts of pork to make this traditional favourite.
                                Made with only premium cuts of pork.
                                Made with gluten-free products.
                                Naturally hardwood smoked.</div>
                        </div>
                    </div>
                </div>
