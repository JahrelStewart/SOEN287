...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="middle">
                <div class="directory">
                    <div class="message">Prime Chicken Wings</div>
                    <div class="innerAisle">MEATS</div>
                </div>

                <div class="product_and_description">
                    <div class="box picture-container">
                        <div class="picture" style="background-image: url(../../images/meatAisle/wings.jpg)">
                        </div>
                    </div>
                    ...
                    <div class="box description">
                        <div class="align">
                            ...
                            <div class="descriptionRow" data-value="800" data-measure="g"><span>WEIGHT</span> 800g</div>
                        ...
                        <div class="smallCarousel">
                            ...
                            <!-- more description -->
                            <div class="detail"> Made with chicken drumettes and winglets that are raised without
                                antibiotics, these frozen wings are easy to cook and serve. The chicken wings are
                                seasoned with natural spices and carefully frozen to seal in the flavour. Perfect
                                as a quick meal or snack, these chicken wings come with a dipping sauce that the whole
                                family will love. </div>
                        </div>
                    </div>
                </div>
