...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="middle">
                <div class="directory">
                    <div class="message">Smoked Bacon</div>
                    <div class="innerAisle">MEATS</div>
                </div>

                <div class="product_and_description">
                    <div class="box picture-container">
                        <div class="picture" style="background-image: url(../../images/meatAisle/bacon.jpg)">
                        </div>
                    </div>
                    ...
                    <div class="box description">
                        <div class="align">
                            ...
                            <div class="descriptionRow" data-value="375" data-measure="g"><span>WEIGHT</span> 375g</div>

                            <div class="descriptionRow" data-value="4.97"><span>PRICE</span> $4.97</div>
                        ...
                        <div class="smallCarousel">
                            ...
                            <!-- more description -->
                            <div class="detail"> Experience hearty smoked bacon with smoked bacon. Crafted from our
                                premium cuts of pork, these delicious bacon slices are naturally smoked to ensure rich
                                flavour. Try this sliced bacon in your favourite breakfast dishes, sandwiches, and
                                salads.</div>
                        </div>
                    </div>
                </div>
