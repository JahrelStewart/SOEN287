...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="middle">
                <div class="directory">
                    <div class="message">Salted Butter</div>
                    <div class="innerAisle">DAIRY</div>
                </div>

                <div class="product_and_description">
                    <div class="box picture-container">
                        <div class="picture" style="background-image: url(../../images/dairyAisle/saltedbutter.jpg)">
                        </div>
                    </div>
                    ...
                    <div class="box description">
                        <div class="align">
                            ...
                            <div class="descriptionRow" data-value="5.00"><span>PRICE</span> $5.00</div>
                        ...
                        <div class="smallCarousel">
                            ...
                            <!-- more description -->
                            <div class="detail">Butter is made with churned 100% pure pasteurized cream.
                                Canada’s number one brand of butter is available in many varieties to suit your
                                taste and lifestyle. Just the right touch of salt.
                            </div>
                        </div>
                    </div>
                </div>
