...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="middle">
                <div class="directory">
                    <div class="message">Whipping Cream 35%</div>
                    <div class="innerAisle">DAIRY</div>
                </div>

                <div class="product_and_description">
                    <div class="box picture-container">
                        <div class="picture" style="background-image: url(../../images/dairyAisle/whippingCream.jpg)">
                        </div>
                    </div>
                    ...
                    <div class="box description">
                        <div class="align">
                            ...
                            <div class="descriptionRow" data-value="473" data-measure="ml"><span>WEIGHT</span> 473ml
                            </div>

                            <div class="descriptionRow" data-value="3.39"><span>PRICE</span> $3.39</div>
                        ...
                        <div class="smallCarousel">
                            ...
                            <!-- more description -->
                            <div class="detail">Ideal for whipping or cooking, 35 % fat whipping
                                cream is a rich all-purpose cream. It's creamy, velvety taste makes it easily
                                to whip and create a perfect fluffy foam to top your strawberries or your pastries.
                            </div>
                        </div>
                    </div>
                </div>
