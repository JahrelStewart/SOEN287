...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="middle">
                <div class="directory">
                    <div class="message">Cream Cheese</div>
                    <div class="innerAisle">DAIRY</div>
                </div>

                <div class="product_and_description">
                    <div class="box picture-container">
                        <div class="picture" style="background-image: url(../../images/dairyAisle/creamcheese.jpg)">
                        </div>
                    </div>
                    ...
                    <div class="box description">
                        <div class="align">
                            ...
                            <div class="descriptionRow" data-value="250" data-measure="g"><span>WEIGHT</span> 250g</div>

                            <div class="descriptionRow" data-value="4.16"><span>PRICE</span> $4.16</div>
                        ...
                        <div class="smallCarousel">
                            ...
                            <!-- more description -->
                            <div class="detail">Philadelphia still sets the bar high for what cream cheese should
                                be and is perfect for adding creaminess to recipes. You already love it for
                                cheesecakes and dips, but be sure to give it a try for making creamy pasta sauce,
                                delectable no-bake desserts, and rich soups.
                            </div>
                        </div>
                    </div>
                </div>
