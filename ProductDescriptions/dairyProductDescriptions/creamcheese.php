...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            $product = $aisles->dairy->creamcheese;
                    ...
                    <div class="product_and_description">
                        ...
                        <div class="box description">
                            ...
                            <div class="smallCarousel">
                                ...
                                <!-- more description -->
                                <div class="detail">Philadelphia cream cheese can be used to make cheesecakes and dips, but be sure to give it a try for making creamy pasta sauce,
                                delectable no-bake desserts, and rich soups.</div>
                            </div>
                        </div>
                    </div>
