...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="middle">
                <div class="directory">
                    <div class="message">Plain Greek Yogurt</div>
                    <div class="innerAisle">DAIRY</div>
                </div>

                <div class="product_and_description">
                    <div class="box picture-container">
                        <div class="picture" style="background-image: url(../../images/dairyAisle/yogurt.jpg)">
                        </div>
                    </div>
                    ...
                    <div class="box description">
                        <div class="align">
                            ...
                            <div class="descriptionRow" data-value="750" data-measure="g"><span>WEIGHT</span> 750g</div>

                            <div class="descriptionRow" data-value="5.36"><span>PRICE</span> $5.36</div>
                        ...
                        <div class="smallCarousel">
                            ...
                            <!-- more description -->
                            <div class="detail">Perfectly plain. Fluffy and fine-textured, it has a very slight
                                natural sweetness and generously rounded mouthfeel that finishes on a perfect point
                                of creaminess. Full of great taste and packed with protein.
                            </div>
                        </div>
                    </div>
                </div>
