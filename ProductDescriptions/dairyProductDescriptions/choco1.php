...
<body>
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="middle">
                <div class="directory">
                    <div class="message">Chocolate Milk 2%</div>
                    <div class="innerAisle">DAIRY</div>
                </div>

                <div class="product_and_description">
                    <div class="box picture-container">
                        <div class="picture" style="background-image: url(../../images/dairyAisle/choco1.jpg)">
                        </div>
                    </div>
                    ...
                    <div class="box description">
                        <div class="align">
                            ...
                            <div class="descriptionRow" data-value="1" data-measure="L"><span>WEIGHT</span> 1L</div>

                            <div class="descriptionRow" data-value="2.78"><span>PRICE</span> $2.78</div>                          
                        ...
                        <div class="smallCarousel">
                            ...
                            <!-- more description -->
                            <div class="detail">Partly skimmed chocolate milk with added vitamins A and D is an
                                excellent source of protein and brings together the nutrition of milk with a delicious
                                chocolate taste you can enjoy. Perfect for a midday snack or after a workout!
                            </div>
                        </div>
                    </div>
                </div>
