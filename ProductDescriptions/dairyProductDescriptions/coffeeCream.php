...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="middle">
                <div class="directory">
                    <div class="message">Coffee Cream 10%</div>
                    <div class="innerAisle">DAIRY</div>
                </div>

                <div class="product_and_description">
                    <div class="box picture-container">
                        <div class="picture" style="background-image: url(../../images/dairyAisle/coffeeCream.jpg)">
                        </div>
                    </div>
                    ...
                    <div class="box description">
                        <div class="align">
                            ...
                            <div class="descriptionRow" data-value="5.58"><span>PRICE</span> $5.58</div>
                        ...
                        <div class="smallCarousel">
                            ...
                            <!-- more description -->
                            <div class="detail">Nothing compares to the fresh flavour and rich, creamy texture of
                                Half & Half cream 10% coffee cream. Add a splash of cream to create a velvety coffee
                                and enhance your recipes with a light and smooth taste.
                            </div>
                        </div>
                    </div>
                </div>
