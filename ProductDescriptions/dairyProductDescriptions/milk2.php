...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="middle">
                <div class="directory">
                    <div class="message">Milk 2%</div>
                    <div class="innerAisle">DAIRY</div>
                </div>

                <div class="product_and_description">
                    <div class="box picture-container">
                        <div class="picture" style="background-image: url(../../images/dairyAisle/milk2.jpeg)">
                        </div>
                    </div>
                    ...
                    <div class="box description">
                        <div class="align">
                            ...
                            <div class="descriptionRow" data-value="4" data-measure="L"><span>WEIGHT</span> 4L</div>

                            <div class="descriptionRow" data-value="6.98"><span>PRICE</span> $6.98</div>
                        ...
                        <div class="smallCarousel">
                            ...
                            <!-- more description -->
                            <div class="detail">Partly skimmed 2% milk combine all the great taste and freshness of
                                milk with many vitamins and minerals necessary to the maintenance of good health.
                                From our farms to your family.</div>
                        </div>
                    </div>
                </div>
