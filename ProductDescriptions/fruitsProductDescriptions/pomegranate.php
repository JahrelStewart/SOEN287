...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="middle">
                <div class="directory">
                    <div class="message">Pomegranate</div>
                    <div class="innerAisle">FRUITS AND VEGETABLES</div>
                </div>

                <div class="product_and_description">
                    <div class="box picture-container">
                        <div class="picture" style="background-image: url(../../images/fruitAisle/pomegranate.jpg)">
                        </div>
                    </div>
                    ...
                    <div class="box description">
                        <div class="align">
                            ...
                            <div class="descriptionRow" data-value="13.75"><span>PRICE</span> $13.75</div>
                        ...
                        <div class="smallCarousel">
                            ...
                            <!-- more description -->
                            <div class="detail">Eating Pomegranates is a great way to start your day! They have been
                                cultivated since ancient times throughout the Mediterranean region.</div>
                        </div>
                    </div>
                </div>
