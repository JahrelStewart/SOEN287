...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            $product = $aisles->fruits->pineapple;
                    ...
                    <div class="product_and_description">
                        ...
                        <div class="box description">
                            ...
                            <div class="smallCarousel">
                                ...
                                <!-- more description -->
                                <div class="detail">Pineapples from Montreal are exequisite fruits. Mix them well with cocktails and other
                                alcholic beverages!</div>
                            </div>
                        </div>
                    </div>
